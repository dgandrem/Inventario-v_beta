//
//  Edit-AddCategoriaViewController.m
//  Inventario v_beta
//
...
@interface Edit_AddCategoriaViewController ()

@end

@implementation Edit_AddCategoriaViewController
...
{
    [super viewDidLoad];
    if([_llamada isEqualToString:@"Add"])
    {
