...
{
    [super viewDidLoad];
    NSMutableArray *detalles = [[NSMutableArray alloc] initWithObjects:@"Producto1",@"Producto2",@"Producto3", nil];
    _ejemplo = [[NSMutableDictionary alloc] initWithObjectsAndKeys: detalles,@"Categoria 1",  nil] ;
